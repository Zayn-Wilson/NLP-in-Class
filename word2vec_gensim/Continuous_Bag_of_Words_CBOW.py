...
class Vocabulary(object):
    ...
    def __init__(self, token_to_idx=None, mask_token="<MASK>", add_unk=True, unk_token="<UNK>"):
        """
        The vocabulary is a mapping of tokens to indices. Each token is assigned
        an index starting from 0. The mask token is reserved for padding and
        the UNK token is reserved for unknown tokens.

        The Vocabulary will have a dictionary which maps tokens to indices
        and an inverse dictionary which maps indices to tokens.
        Args:
